...
export const organizationSchema = {
  ...
  name: 'Nuvv',
  alternateName: ['Nuvv Fibra', 'Nuvv Conectividade & Tecnologia'],
  legalName: 'Nuvv Tecnologia Ltda',
  url: BASE_URL,
  logo: `${BASE_URL}/images/external/favicon.png`,
...
export const createCitySchema = (cityName: string, state: string = 'SP') => ({
  ...
  name: `Nuvv - Fibra Óptica Residencial e Link Dedicado Empresarial em ${cityName} / ${state}`,
